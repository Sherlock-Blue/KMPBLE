  ...
  fun `WriteCharacteristic with null Gatt returns CallbackError BleEvent`() =
    runTest {
      ...
      launch {
        ...
        // Assert
        Assert.assertTrue(peripheral.writeCharacteristic(DEFAULT_UUID, data = byteArrayOf()) is BleEvent.CallbackError)
  ...
  fun `WriteCharacteristic with invalid UUID returns CallbackError BleEvent`() =
    runTest {
      ...
      launch {
        ...
        // Assert
        Assert.assertTrue(peripheral.writeCharacteristic("INVALID UUID", data = byteArrayOf()) is BleEvent.CallbackError)
  ...
  fun `WriteCharacteristic returns OnCharacteristicWrite BleEvent`() =
    runTest {
      ...
      launch {
        ...
        // Assert
        Assert.assertTrue(peripheral.writeCharacteristic(DEFAULT_UUID, data = byteArrayOf()) is BleEvent.OnCharacteristicWrite)
  ...
  fun `WriteCharacteristic returns an OnCharacteristicWrite BleEvent`() =
    runTest {
      launch {
        ...
        // Assert
        Assert.assertTrue(peripheral.writeCharacteristic(DEFAULT_UUID, byteArrayOf()) is BleEvent.OnCharacteristicWrite)
