...
class PeripheralWriteCharacteristicTest {
  ...
  @Test
  fun `WriteCharacteristic with null Gatt returns an Error BleResponse`() =
    runTest {
      // Arrange
      // Mocked Fixtures
      ...
      launch {
        ...
        // Assert
        Assert.assertTrue(peripheral.writeCharacteristic(DEFAULT_UUID, data = byteArrayOf()) is BleResponse.Error)
  ...
  fun `WriteCharacteristic with invalid UUID returns an Error BleResponse`() =
    runTest {
      ...
      launch {
        ...
        // Assert
        Assert.assertTrue(peripheral.writeCharacteristic("INVALID UUID", data = byteArrayOf()) is BleResponse.Error)
  ...
  fun `WriteCharacteristic returns OnCharacteristicWrite BleResponse`() =
    runTest {
      ...
      launch {
        ...
        // Assert
        Assert.assertTrue(peripheral.writeCharacteristic(DEFAULT_UUID, data = byteArrayOf()) is BleResponse.CharacteristicWrite)
  ...
  @Test
  fun `WriteCharacteristic returns an CharacteristicWrite BleResponse`() =
    runTest {
      launch {
        // Arrange
        // Mocked Fixtures
        ...
        // Assert
        Assert.assertTrue(peripheral.writeCharacteristic(DEFAULT_UUID, byteArrayOf()) is BleResponse.CharacteristicWrite)
