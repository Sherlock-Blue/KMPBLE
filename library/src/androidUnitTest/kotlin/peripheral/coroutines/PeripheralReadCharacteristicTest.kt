  ...
  fun `ReadCharacteristic with null Gatt returns an Error BleResponse`() =
    runTest {
      ...
      launch {
        ...
        // Assert
        Assert.assertTrue(peripheral.readCharacteristic(TEST_UUID) is BleResponse.Error)
  ...
  fun `ReadCharacteristic returns CharacteristicRead BleResponse`() =
    runTest {
      ...
      launch {
        ...
        // Assert
        Assert.assertTrue(peripheral.readCharacteristic(TEST_UUID) is BleResponse.CharacteristicRead)
